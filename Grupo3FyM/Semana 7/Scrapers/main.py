...
from scrapers import scraper_nicolas, scraper_perez

# 1. Recolectamos listas de Python de todos los estudiantes
data_nicolas = scraper_nicolas.ejecutar_extraccion()
...
# 3. Spark convierte las listas en un solo DataFrame unificado
 df_nicolas = spark.createDataFrame(data_nicolas)
 df_perez = spark.createDataFrame(data_perez)

 df_final = df_nicolas.union(df_perez)
